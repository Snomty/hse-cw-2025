...
def main():
    ...
    start_row, end_row, file_name = 0, 1000, "df_train_for_cv_minacov"
    # start_row, end_row, file_name = 1000, 2000, "df_train_for_cv_baryshev"
    # start_row, end_row, file_name = 2000, 3000, "df_train_for_cv_almetov"
